/**
 * Create Teva Naot schema and tables.
 * Accepts the same `schemas` format as create-hypertoy-schema.js —
 * built dynamically from GCS CSV headers + column-aliases-tevanaot.js.
 */
