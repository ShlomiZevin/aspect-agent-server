/**
 * Create The Social Supermarket schema and tables.
 * Accepts the same `schemas` format as create-zolstock-schema.js —
 * built dynamically from GCS CSV headers + column-aliases-superhist.js.
 *
