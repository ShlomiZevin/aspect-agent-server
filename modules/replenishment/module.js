      ...
      return [{
        ...
        promptFragment: (context) => {
          ...
          return 'This conversation is the SMART TUNE panel of the Procurement screen, '
            ...
            + 'without proposing.\n'
            + 'RESOLUTION PRECEDENCE for a change: prefer STRONG attributes — an explicit '
            + 'SKU list (resolve it with fetch_replenishment first), exact category/'
            + 'subcategory labels as delivered, supplier — over free-text name matching, '
            + 'which is the LAST resort. Explore with the READ tool until the filter '
            + 'matches the right set, then call propose_group_change ONCE per user '
