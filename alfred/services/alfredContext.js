...
const STATIC_SYSTEM_PROMPT = [
  ...
  '- `clear` a field · `transition` to an existing crew (fires',
  '  immediately by default and SKIPS the rest of this chain — the',
  '  target crew answers this turn; `fireImmediately: false` lets this',
  '  crew\'s Talker answer once more and hands over next turn) · `stop`',
  ...
  'Rules addon BEFORE it — rule matches → transition (which itself',
  'stops the chain — thinker never runs, instant + free); no match →',
