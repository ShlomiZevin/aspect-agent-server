...
class WelcomeOnboarding extends CrewMember {
  constructor() {
    super({
      ...
      fieldsToCollect: [
            {
                  "name": "user_name",
                  "description": "The user's name or preferred nickname for personal interaction"
            },
            {
                  "name": "gender",
                  "description": "User's gender for proper Hebrew language agreement (ask early in conversation)"
            },
            {
                  "name": "age",
                  "description": "User's age or date of birth to verify eligibility (must be 16+)"
            },
            {
                  "name": "account_type",
                  "description": "Type of account requested - must be 'personal' to proceed"
            },
            {
                  "name": "service_consent",
                  "description": "Agreement to use LYBI service - required to continue"
            }
      ],
...
1. LYBI's own gender: LYBI is always female. All self-references use feminine form at all times (אני עוזרת, אני כאן).All self-references use feminine form at all times"
...
module.exports = WelcomeOnboarding;
