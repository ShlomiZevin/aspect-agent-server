  ...
  constructor() {
    super({
      ...
      fieldsToCollect: [
        ...
        { name: 'incomeRange', description: 'Monthly income in NIS — number or range (e.g. 4000, 4000-5000). Not qualitative.', ui: { type: 'buttons', guidance: 'offer 3 NIS income ranges appropriate for the user profile' } },
        { name: 'expensesRange', description: 'Monthly expenses in NIS — number or range (e.g. 3000, 3000-4000). Not qualitative.', ui: { type: 'buttons', guidance: 'offer 3 NIS expense ranges appropriate for the user profile' } },
